...
fig.add_trace(go.Scatter(x=[mean_of_sample2, mean_of_sample2], y=[
              0, 1.4], mode="lines", name="MEAN OF STUDENTS WHO USED THE APP"))
fig.add_trace(go.Scatter(x=[first_std_deviation_end, first_std_deviation_end], y=[
              0, 1.4], mode="lines", name="STANDARD DEVIATION 1 END"))
fig.add_trace(go.Scatter(x=[second_std_deviation_end, second_std_deviation_end], y=[
              0, 1.4], mode="lines", name="STANDARD DEVIATION 2 END"))
...
fig.add_trace(go.Scatter(x=[mean_of_sample3, mean_of_sample3], y=[
              0, 1.4], mode="lines", name="MEAN OF STUDNETS WHO WERE ENFORCED WITH MATH REGISTERS"))
fig.add_trace(go.Scatter(x=[second_std_deviation_end, second_std_deviation_end], y=[
              0, 1.4], mode="lines", name="STANDARD DEVIATION 2 END"))
fig.add_trace(go.Scatter(x=[third_std_deviation_end, third_std_deviation_end], y=[
              0, 1.4], mode="lines", name="STANDARD DEVIATION 3 END"))
